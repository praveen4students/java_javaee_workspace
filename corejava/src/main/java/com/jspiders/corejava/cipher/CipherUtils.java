...
public class CipherUtils {
	/*private static byte[] key = { 0x24, 0x68, 0x78, 0x71, 0x49, 0x73, 0x41, 0x24, 0x28, 0x78, 0x41, 0x49, 0x63, 0x41,
			0x73, 0x9 };// "this Is A SecretKey you can change it, size is 16";
*/
	
	private static String secretKey = "My Name is Prave";
	private static byte[] key = secretKey.getBytes();
